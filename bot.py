...
(simulate_new_hands(hand, d))



def discard_value_calculator(handSetDict):
    # handSet should be the dictionary generated by the simulate_new_hands function
    discardValues = {}

    for discardSet, handSet in handSetDict.items():
        discardValues[discardSet] = 0
        for hand in handSet:
            handValue = hand_rank(hand)
            probability = hand_probability(hand)
...
discard_value_calculator((simulate_new_hands(hand, d)))
